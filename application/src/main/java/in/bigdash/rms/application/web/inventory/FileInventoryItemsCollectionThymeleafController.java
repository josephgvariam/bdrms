...
/**
 * = FileInventoryItemsCollectionThymeleafController
 *
 * TODO Auto-generated class documentation
 *
 */
@RooController(entity = FileInventoryItem.class, type = ControllerType.COLLECTION)
@RooThymeleaf
@Controller
@RequestMapping(value = "/fileinventoryitems", name = "FileInventoryItemsCollectionThymeleafController", produces = MediaType.TEXT_HTML_VALUE)
public class FileInventoryItemsCollectionThymeleafController {
     ...
     */
    @Autowired
    public FileInventoryItemsCollectionThymeleafController(FileInventoryItemService fileInventoryItemService, ConversionService conversionService, MessageSource messageSource, ControllerMethodLinkBuilderFactory linkBuilder) {
    ...
    public ResponseEntity<ConvertedDatatablesData<FileInventoryItem>> datatables(DatatablesColumns datatablesColumns, GlobalSearch search, DatatablesPageable pageable, @RequestParam("draw") Integer draw) {
        ...
        if (search != null && StringUtils.isNotBlank(search.getText())) {
            totalFileInventoryItemsCount = getFileInventoryItemService().count();
        }
        ConvertedDatatablesData<FileInventoryItem> datatablesData = new ConvertedDatatablesData<FileInventoryItem>(fileInventoryItems, totalFileInventoryItemsCount, draw, getConversionService(), datatablesColumns);
    ...
    public void export(GlobalSearch search, @PageableDefault(size = 2147483647) Pageable pageable, String[] datatablesColumns, HttpServletResponse response, JasperReportsExporter exporter, String fileName, Locale locale) {
        ...
        if (fileInventoryItems == null || fileInventoryItems.getContent().isEmpty()) {
            return;
        }
        ...
        JRDataSource ds = new JRBeanCollectionDataSource(fileInventoryItems.getContent());
    ...
    public ResponseEntity<?> exportCsv(GlobalSearch search, @PageableDefault(size = 2147483647) Pageable pageable, @RequestParam("datatablesColumns") String[] datatablesColumns, HttpServletResponse response, Locale locale) {
        export(search, pageable, datatablesColumns, response, new JasperReportsCsvExporter(), "fileInventoryItems_report.csv", locale);
        return ResponseEntity.ok().build();
    }
    ...
    public ResponseEntity<?> exportPdf(GlobalSearch search, @PageableDefault(size = 2147483647) Pageable pageable, @RequestParam("datatablesColumns") String[] datatablesColumns, HttpServletResponse response, Locale locale) {
        export(search, pageable, datatablesColumns, response, new JasperReportsPdfExporter(), "fileInventoryItems_report.pdf", locale);
        return ResponseEntity.ok().build();
    }
    ...
    public ResponseEntity<?> exportXls(GlobalSearch search, @PageableDefault(size = 2147483647) Pageable pageable, @RequestParam("datatablesColumns") String[] datatablesColumns, HttpServletResponse response, Locale locale) {
        export(search, pageable, datatablesColumns, response, new JasperReportsXlsExporter(), "fileInventoryItems_report.xls", locale);
        return ResponseEntity.ok().build();
    }
    ...
    public void addColumnToReportBuilder(String columnName, FastReportBuilder builder, Locale locale, String fileName) {
        try {
            if (columnName.equals("id")) {
                builder.addColumn(getMessageSource().getMessage("label_fileinventoryitem_id", null, "Id", locale), "id", Long.class.getName(), 50);
            } else if (columnName.equals("version")) {
                builder.addColumn(getMessageSource().getMessage("label_fileinventoryitem_version", null, "Version", locale), "version", Long.class.getName(), 100);
            } else if (columnName.equals("ref1")) {
                builder.addColumn(getMessageSource().getMessage("label_fileinventoryitem_ref1", null, "Ref 1", locale), "ref1", String.class.getName(), 100);
            } else if (columnName.equals("ref2")) {
                builder.addColumn(getMessageSource().getMessage("label_fileinventoryitem_ref2", null, "Ref 2", locale), "ref2", String.class.getName(), 100);
            } else if (columnName.equals("ref3")) {
                builder.addColumn(getMessageSource().getMessage("label_fileinventoryitem_ref3", null, "Ref 3", locale), "ref3", String.class.getName(), 100);
            } else if (columnName.equals("ref4")) {
                builder.addColumn(getMessageSource().getMessage("label_fileinventoryitem_ref4", null, "Ref 4", locale), "ref4", String.class.getName(), 100);
            } else if (columnName.equals("ref5")) {
                builder.addColumn(getMessageSource().getMessage("label_fileinventoryitem_ref5", null, "Ref 5", locale), "ref5", String.class.getName(), 100);
            } else if (columnName.equals("status")) {
                builder.addColumn(getMessageSource().getMessage("label_fileinventoryitem_status", null, "Status", locale), "status", InventoryItemStatus.class.getName(), 100);
            }
