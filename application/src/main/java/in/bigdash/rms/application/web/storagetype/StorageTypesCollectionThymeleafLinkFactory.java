...
@Component
public class StorageTypesCollectionThymeleafLinkFactory implements MethodLinkFactory<StorageTypesCollectionThymeleafController> {
    ...
    public Class<StorageTypesCollectionThymeleafController> getControllerClass() {
