...
/**
 * = DocumentsItemThymeleafLinkFactory
 *
 * TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = DocumentsItemThymeleafController.class)
@Component
public class DocumentsItemThymeleafLinkFactory implements MethodLinkFactory<DocumentsItemThymeleafController> {
     ...
     * @return Class
     */
    public Class<DocumentsItemThymeleafController> getControllerClass() {
