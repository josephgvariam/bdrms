...
/**
 * = DestructionRequestsCollectionThymeleafLinkFactory
 *
 * TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = DestructionRequestsCollectionThymeleafController.class)
@Component
public class DestructionRequestsCollectionThymeleafLinkFactory implements MethodLinkFactory<DestructionRequestsCollectionThymeleafController> {
     ...
     * @return Class
     */
    public Class<DestructionRequestsCollectionThymeleafController> getControllerClass() {
        return DestructionRequestsCollectionThymeleafController.class;
    }
