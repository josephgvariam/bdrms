...
/**
 * = TransferRequestsCollectionThymeleafLinkFactory
 *
 * TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = TransferRequestsCollectionThymeleafController.class)
@Component
public class TransferRequestsCollectionThymeleafLinkFactory implements MethodLinkFactory<TransferRequestsCollectionThymeleafController> {
     ...
     * @return Class
     */
    public Class<TransferRequestsCollectionThymeleafController> getControllerClass() {
        return TransferRequestsCollectionThymeleafController.class;
    }
