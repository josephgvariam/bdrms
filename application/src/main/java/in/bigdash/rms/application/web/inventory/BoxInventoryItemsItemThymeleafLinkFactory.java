...
/**
 * = BoxInventoryItemsItemThymeleafLinkFactory
 *
 * TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = BoxInventoryItemsItemThymeleafController.class)
@Component
public class BoxInventoryItemsItemThymeleafLinkFactory implements MethodLinkFactory<BoxInventoryItemsItemThymeleafController> {
     ...
     * @return Class
     */
    public Class<BoxInventoryItemsItemThymeleafController> getControllerClass() {
        return BoxInventoryItemsItemThymeleafController.class;
    }
