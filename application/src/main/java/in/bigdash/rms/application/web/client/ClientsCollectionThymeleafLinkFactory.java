...
@Component
public class ClientsCollectionThymeleafLinkFactory implements MethodLinkFactory<ClientsCollectionThymeleafController> {
     ...
     * @return Class
     */
    public Class<ClientsCollectionThymeleafController> getControllerClass() {
