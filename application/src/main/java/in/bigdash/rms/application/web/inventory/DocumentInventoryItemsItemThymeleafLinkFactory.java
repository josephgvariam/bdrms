...
/**
 * = DocumentInventoryItemsItemThymeleafLinkFactory
 *
 * TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = DocumentInventoryItemsItemThymeleafController.class)
@Component
public class DocumentInventoryItemsItemThymeleafLinkFactory implements MethodLinkFactory<DocumentInventoryItemsItemThymeleafController> {
     ...
     * @return Class
     */
    public Class<DocumentInventoryItemsItemThymeleafController> getControllerClass() {
        return DocumentInventoryItemsItemThymeleafController.class;
    }
