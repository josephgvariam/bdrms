...
@Component
public class UsersCollectionThymeleafLinkFactory implements MethodLinkFactory<UsersCollectionThymeleafController> {
    ...
    public Class<UsersCollectionThymeleafController> getControllerClass() {
