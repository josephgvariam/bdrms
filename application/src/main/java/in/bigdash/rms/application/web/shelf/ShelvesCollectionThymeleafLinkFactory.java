...
/**
 * = ShelvesCollectionThymeleafLinkFactory
 *
 * TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = ShelvesCollectionThymeleafController.class)
@Component
public class ShelvesCollectionThymeleafLinkFactory implements MethodLinkFactory<ShelvesCollectionThymeleafController> {
     ...
     * @return Class
     */
    public Class<ShelvesCollectionThymeleafController> getControllerClass() {
        return ShelvesCollectionThymeleafController.class;
    }
