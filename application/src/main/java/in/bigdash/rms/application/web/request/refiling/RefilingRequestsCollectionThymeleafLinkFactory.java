...
/**
 * = RefilingRequestsCollectionThymeleafLinkFactory
 *
 * TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = RefilingRequestsCollectionThymeleafController.class)
@Component
public class RefilingRequestsCollectionThymeleafLinkFactory implements MethodLinkFactory<RefilingRequestsCollectionThymeleafController> {
     ...
     * @return Class
     */
    public Class<RefilingRequestsCollectionThymeleafController> getControllerClass() {
        return RefilingRequestsCollectionThymeleafController.class;
    }
