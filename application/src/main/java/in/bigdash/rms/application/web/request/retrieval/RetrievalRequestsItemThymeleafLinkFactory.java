...
/**
 * = RetrievalRequestsItemThymeleafLinkFactory
 *
 * TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = RetrievalRequestsItemThymeleafController.class)
@Component
public class RetrievalRequestsItemThymeleafLinkFactory implements MethodLinkFactory<RetrievalRequestsItemThymeleafController> {
     ...
     * @return Class
     */
    public Class<RetrievalRequestsItemThymeleafController> getControllerClass() {
        return RetrievalRequestsItemThymeleafController.class;
    }
