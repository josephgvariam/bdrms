...
/**
 * = PermoutRequestsCollectionThymeleafLinkFactory
 *
 * TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = PermoutRequestsCollectionThymeleafController.class)
@Component
public class PermoutRequestsCollectionThymeleafLinkFactory implements MethodLinkFactory<PermoutRequestsCollectionThymeleafController> {
     ...
     * @return Class
     */
    public Class<PermoutRequestsCollectionThymeleafController> getControllerClass() {
        return PermoutRequestsCollectionThymeleafController.class;
    }
