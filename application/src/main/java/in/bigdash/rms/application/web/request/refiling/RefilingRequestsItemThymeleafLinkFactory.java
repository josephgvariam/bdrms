...
/**
 * = RefilingRequestsItemThymeleafLinkFactory
 *
 * TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = RefilingRequestsItemThymeleafController.class)
@Component
public class RefilingRequestsItemThymeleafLinkFactory implements MethodLinkFactory<RefilingRequestsItemThymeleafController> {
     ...
     * @return Class
     */
    public Class<RefilingRequestsItemThymeleafController> getControllerClass() {
        return RefilingRequestsItemThymeleafController.class;
    }
