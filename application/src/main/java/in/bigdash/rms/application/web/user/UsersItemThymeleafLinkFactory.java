...
@Component
public class UsersItemThymeleafLinkFactory implements MethodLinkFactory<UsersItemThymeleafController> {
    ...
    public Class<UsersItemThymeleafController> getControllerClass() {
