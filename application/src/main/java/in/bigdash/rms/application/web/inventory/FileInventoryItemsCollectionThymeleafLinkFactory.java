...
/**
 * = FileInventoryItemsCollectionThymeleafLinkFactory
 *
 * TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = FileInventoryItemsCollectionThymeleafController.class)
@Component
public class FileInventoryItemsCollectionThymeleafLinkFactory implements MethodLinkFactory<FileInventoryItemsCollectionThymeleafController> {
     ...
     * @return Class
     */
    public Class<FileInventoryItemsCollectionThymeleafController> getControllerClass() {
        return FileInventoryItemsCollectionThymeleafController.class;
    }
