...
public class DocumentsCollectionThymeleafController {
    ...
    @Autowired
    public DocumentsCollectionThymeleafController(DocumentService documentService, ConversionService conversionService, MessageSource messageSource, ControllerMethodLinkBuilderFactory linkBuilder) {
    ...
    @ResponseBody
    public ResponseEntity<ConvertedDatatablesData<Document>> datatables(DatatablesColumns datatablesColumns, GlobalSearch search, DatatablesPageable pageable, @RequestParam("draw") Integer draw) {
    ...
    @ResponseBody
    public ResponseEntity<ConvertedDatatablesData<Document>> datatablesByIdsIn(@RequestParam("ids") List<Long> ids, DatatablesColumns datatablesColumns, GlobalSearch search, DatatablesPageable pageable, @RequestParam("draw") Integer draw) {
    ...
    @ResponseBody
    public ResponseEntity<Select2DataSupport<Document>> select2(GlobalSearch search, Pageable pageable, Locale locale) {
        Page<Document> documents = getDocumentService().findAll(search, pageable);
    ...
    public ModelAndView create(@Valid @ModelAttribute Document document, BindingResult result, Model model) {
        if (result.hasErrors()) {
            populateForm(model);
    ...
    public void addColumnToReportBuilder(String columnName, FastReportBuilder builder, Locale locale, String fileName) {
        try {
            if (columnName.equals("id")) {
                ...
                builder.addColumn(getMessageSource().getMessage("label_document_barcode", null, "Barcode", locale), "barcode", String.class.getName(), 100);
            } else if (columnName.equals("location")) {
                builder.addColumn(getMessageSource().getMessage("label_document_location", null, "Location", locale), "location", String.class.getName(), 100);
                ...
                builder.addColumn(getMessageSource().getMessage("label_document_modifieddate", null, "Modified Date", locale), "modifiedDate", Calendar.class.getName(), 100);
            } else if (columnName.equals("modifiedBy")) {
                builder.addColumn(getMessageSource().getMessage("label_document_modifiedby", null, "Modified By", locale), "modifiedBy", String.class.getName(), 100);
            }
