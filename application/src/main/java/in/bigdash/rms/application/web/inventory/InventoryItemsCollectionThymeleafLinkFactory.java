...
/**
 * = InventoryItemsCollectionThymeleafLinkFactory
 *
 * TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = InventoryItemsCollectionThymeleafController.class)
@Component
public class InventoryItemsCollectionThymeleafLinkFactory implements MethodLinkFactory<InventoryItemsCollectionThymeleafController> {
     ...
     * @return Class
     */
    public Class<InventoryItemsCollectionThymeleafController> getControllerClass() {
        return InventoryItemsCollectionThymeleafController.class;
    }
