...
/**
 * = PickupRequestsItemThymeleafLinkFactory
 *
 * TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = PickupRequestsItemThymeleafController.class)
@Component
public class PickupRequestsItemThymeleafLinkFactory implements MethodLinkFactory<PickupRequestsItemThymeleafController> {
     ...
     * @return Class
     */
    public Class<PickupRequestsItemThymeleafController> getControllerClass() {
        return PickupRequestsItemThymeleafController.class;
    }
