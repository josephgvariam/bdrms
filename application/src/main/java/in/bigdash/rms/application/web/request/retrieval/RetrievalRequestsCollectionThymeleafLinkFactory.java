...
/**
 * = RetrievalRequestsCollectionThymeleafLinkFactory
 *
 * TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = RetrievalRequestsCollectionThymeleafController.class)
@Component
public class RetrievalRequestsCollectionThymeleafLinkFactory implements MethodLinkFactory<RetrievalRequestsCollectionThymeleafController> {
     ...
     * @return Class
     */
    public Class<RetrievalRequestsCollectionThymeleafController> getControllerClass() {
        return RetrievalRequestsCollectionThymeleafController.class;
    }
