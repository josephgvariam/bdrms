...
/**
 * = PickupRequestsCollectionThymeleafLinkFactory
 *
 * TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = PickupRequestsCollectionThymeleafController.class)
@Component
public class PickupRequestsCollectionThymeleafLinkFactory implements MethodLinkFactory<PickupRequestsCollectionThymeleafController> {
     ...
     * @return Class
     */
    public Class<PickupRequestsCollectionThymeleafController> getControllerClass() {
        return PickupRequestsCollectionThymeleafController.class;
    }
