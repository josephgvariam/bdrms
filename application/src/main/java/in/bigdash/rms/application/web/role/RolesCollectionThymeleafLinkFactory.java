...
@Component
public class RolesCollectionThymeleafLinkFactory implements MethodLinkFactory<RolesCollectionThymeleafController> {
    ...
    public Class<RolesCollectionThymeleafController> getControllerClass() {
        return RolesCollectionThymeleafController.class;
    }
