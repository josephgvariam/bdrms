...
/**
 * = TransferRequestsCollectionThymeleafController
 *
 * TODO Auto-generated class documentation
 *
 */
@RooController(entity = TransferRequest.class, type = ControllerType.COLLECTION)
@RooThymeleaf
@Controller
...
public class TransferRequestsCollectionThymeleafController {
    ...
    public ModelAndView create(@Valid @ModelAttribute TransferRequest transferRequest, BindingResult result, Model model) {
        if (result.hasErrors()) {
            populateForm(model);
