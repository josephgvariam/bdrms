...
/**
 * = DocumentInventoryItemsCollectionThymeleafLinkFactory
 *
 * TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = DocumentInventoryItemsCollectionThymeleafController.class)
@Component
public class DocumentInventoryItemsCollectionThymeleafLinkFactory implements MethodLinkFactory<DocumentInventoryItemsCollectionThymeleafController> {
     ...
     * @return Class
     */
    public Class<DocumentInventoryItemsCollectionThymeleafController> getControllerClass() {
        return DocumentInventoryItemsCollectionThymeleafController.class;
    }
