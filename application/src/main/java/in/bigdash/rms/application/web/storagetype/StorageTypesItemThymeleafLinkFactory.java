...
@Component
public class StorageTypesItemThymeleafLinkFactory implements MethodLinkFactory<StorageTypesItemThymeleafController> {
    ...
    public Class<StorageTypesItemThymeleafController> getControllerClass() {
