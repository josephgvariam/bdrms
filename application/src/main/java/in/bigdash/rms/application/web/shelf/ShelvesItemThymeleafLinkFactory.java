...
/**
 * = ShelvesItemThymeleafLinkFactory
 *
 * TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = ShelvesItemThymeleafController.class)
@Component
public class ShelvesItemThymeleafLinkFactory implements MethodLinkFactory<ShelvesItemThymeleafController> {
     ...
     * @return Class
     */
    public Class<ShelvesItemThymeleafController> getControllerClass() {
        return ShelvesItemThymeleafController.class;
    }
