...
/**
 * = DestructionRequestsItemThymeleafLinkFactory
 *
 * TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = DestructionRequestsItemThymeleafController.class)
@Component
public class DestructionRequestsItemThymeleafLinkFactory implements MethodLinkFactory<DestructionRequestsItemThymeleafController> {
     ...
     * @return Class
     */
    public Class<DestructionRequestsItemThymeleafController> getControllerClass() {
        return DestructionRequestsItemThymeleafController.class;
    }
