...
/**
 * = InsertionRequestsItemThymeleafLinkFactory
 *
 * TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = InsertionRequestsItemThymeleafController.class)
@Component
public class InsertionRequestsItemThymeleafLinkFactory implements MethodLinkFactory<InsertionRequestsItemThymeleafController> {
     ...
     * @return Class
     */
    public Class<InsertionRequestsItemThymeleafController> getControllerClass() {
        return InsertionRequestsItemThymeleafController.class;
    }
