...
/**
 * = PermoutRequestsItemThymeleafLinkFactory
 *
 * TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = PermoutRequestsItemThymeleafController.class)
@Component
public class PermoutRequestsItemThymeleafLinkFactory implements MethodLinkFactory<PermoutRequestsItemThymeleafController> {
     ...
     * @return Class
     */
    public Class<PermoutRequestsItemThymeleafController> getControllerClass() {
        return PermoutRequestsItemThymeleafController.class;
    }
