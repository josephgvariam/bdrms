...
/**
 * = FacilitiesCollectionThymeleafLinkFactory
 *
 * TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = FacilitiesCollectionThymeleafController.class)
@Component
public class FacilitiesCollectionThymeleafLinkFactory implements MethodLinkFactory<FacilitiesCollectionThymeleafController> {
     ...
     * @return Class
     */
    public Class<FacilitiesCollectionThymeleafController> getControllerClass() {
        return FacilitiesCollectionThymeleafController.class;
    }
