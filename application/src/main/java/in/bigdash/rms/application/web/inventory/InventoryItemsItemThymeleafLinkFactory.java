...
/**
 * = InventoryItemsItemThymeleafLinkFactory
 *
 * TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = InventoryItemsItemThymeleafController.class)
@Component
public class InventoryItemsItemThymeleafLinkFactory implements MethodLinkFactory<InventoryItemsItemThymeleafController> {
     ...
     * @return Class
     */
    public Class<InventoryItemsItemThymeleafController> getControllerClass() {
        return InventoryItemsItemThymeleafController.class;
    }
