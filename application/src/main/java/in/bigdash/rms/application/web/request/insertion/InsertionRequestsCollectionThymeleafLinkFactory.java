...
/**
 * = InsertionRequestsCollectionThymeleafLinkFactory
 *
 * TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = InsertionRequestsCollectionThymeleafController.class)
@Component
public class InsertionRequestsCollectionThymeleafLinkFactory implements MethodLinkFactory<InsertionRequestsCollectionThymeleafController> {
     ...
     * @return Class
     */
    public Class<InsertionRequestsCollectionThymeleafController> getControllerClass() {
        return InsertionRequestsCollectionThymeleafController.class;
    }
